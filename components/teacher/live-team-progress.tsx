          ...
          return (
            <Card
              ...
              className={`border-border/50 bg-white transition-shadow hover:shadow-md ${
                stuck ? "ring-1 ring-[#FAC846]/50" : ""
              }`}
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="min-w-0">
                    <p className="font-semibold text-sm text-[#00323C] truncate">
                      {index === 0 && teams.length > 1 && (
                        <Trophy className="inline h-3.5 w-3.5 text-[#FAC846] mr-1 -mt-0.5" />
                      )}
                      {team.name}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div>
                    ...
                    <p className="font-bold text-lg text-[#00D296] leading-none">
                      {team.total_points}
                    </p>
                  </div>
                  <div>
